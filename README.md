...
whisper (pronounced "gossip") is a library that lets you make phone calls using
...
whisper is most suitable for backend telephony applications. This is especially
true for apps that do interesting things with audio. whisper supports DSP out of
...
of the telephony app developer. whisper sets you free from Asterisk because you
can have everything in a single easy-to-deploy binary.

whisper has excellent support for SRV/NAPTR failover by way of timeouts, ICMP
...
whisper is lightweight enough that you can actually design your app to use a
...
whisper parses SIP messages using the Ragel finite state machine compiler. Much
...
whisper is less suitable for PBX, IVR, and VoIP reselling. For these things, you
